 ...
 * Sesi di perangkat lain dicabut; keluar paling lambat MASA_TOKEN_MENIT kemudian (lihat services/akun).
 */
  ...
  return (
    <FormHasil action={gantiPassword} resetSaatBerhasil className="space-y-5">
      ...
      <p className="text-xs text-muted">
        Setelah password diganti, perangkat lain yang sedang login dengan akun ini akan keluar otomatis paling lambat{" "}
        {MASA_TOKEN_MENIT} menit kemudian.
      </p>
